...
먼저 공식 사이트인 https://github.com/ 에서 회원가입을 합니다. 회원가입 후 로그인을 하고 **_"Start a project"_** 버튼을 클릭합니다. 래 그림처럼 화면이 나옵니다.
...
Marketplace에서 Egit를 검색한다. 아래 그림처럼 **EGit - Git Integration for Eclipse**를 찾아 설치합니다. 설치가 완료되면 이클립스를 다시 실행하게 됩니다.
...
Git 을 선택하고 **[OK]** 버튼을 눌러 활성화시킵니다. Git 퍼스펙티브가 추가된 것을 볼 수 있으며 아이콘을 클릭하면 아래 그림처럼 기본화면이 변경됩니다.
...
원격 저장소에 첫 번째로 합니다. 프로젝트를 마우스 우클릭 후 **[Team] -> [Commit]**을 클릭합니다.
...
그럼 로그인 창이 뜰 텐데, GitHub의 아이디와 비밀번호를 입력하시고 **[OK]** 버튼을 클릭합니다. Push 확인 화면이 보여지는데 확인하고 **[Finish]** 버튼을 클릭합니다.
...
[GitHub](https://github.com/) 홈페이지를 가서 Push 된 프로젝트를 확인 할 수 있습니다. 그림처럼 프로젝트가 올라가있고 수정된 이력도 보입니다. 이클립스에서 소스 코드를 수정하고 위에서 본 **Commit** 과정과 같이 하면 프로젝트를 관리할 수 있습니다.
