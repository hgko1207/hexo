---
title: '[CentOS] Apache Zookeeper 설치 및 사용'
categories:
  - Server
  - Linux
tags:
...
위의 설명처럼 메시키 큐를 관리하고 동기 서비스 및 대용량 분산 시스템을 구축하기 위해 `Apache ZooKeeper` 를 사용할 경우가 있습니다. `Apache ZooKeeper` 설치 및 사용 방법을 정리하였습니다.
