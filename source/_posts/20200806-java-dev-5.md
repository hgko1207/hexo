...
동네예보 정보를 조회하기 위해 [공공데이터 포털](https://www.data.go.kr/index.do) 사이트의 동네예보 조회서비스 API를 사용하였습니다.

## Open API 활용 방법

- [동네예보 조회서비스](https://www.data.go.kr/data/15057682/openapi.do) 사이트에서 활용신청을 하고 Service Key를 발급받습니다.
- 오픈 API 활용 가이드를 다운로드 하여 조회 조건 및 결과 데이터를 이해합니다.
